  ...
  <div class="menu">
    ...
    <div class="menu__list">
      <div class="menu__data">
        <div class="menu__data-before" ref="beforeElm">
          ...
          <span class="fz-headline" v-if="post.data.menu.length">{{ post.data.menu[0].title }}</span>
        </div>
        <div class="menu__data-after fz-headline" v-if="post.data.menu.length">{{ post.data.menu[0].content }}</div>
      </div>
      <swiper
          class="menu__swiper"
          @swiper="onSwiper"
          :modules="modules"
      >
        <swiper-slide v-for="item in post.data.menu" :key="item.id">
          <div class="menu__item" :data-title="item.title">
            <a class="menu__link" v-if="item.content">{{ item.content }}</a>
          </div>
        </swiper-slide>
      </swiper>
    </div>
